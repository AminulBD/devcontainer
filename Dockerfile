...
ARG GO_VERSION=1.22.12,1.23.12,1.24.13,1.25.9,1.26.2
ARG DENO_VERSION=1.46.3,2.0.6,2.1.14,2.2.15,2.3.7,2.4.5,2.5.7,2.6.10,2.7.12
ARG PYTHON_VERSION=2.7,3.8,3.9,3.10,3.11,3.12,3.13,3.14,3.15
